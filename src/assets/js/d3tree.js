var url = "https://asg-portal-backend-733243988471.europe-west1.run.app/taxonomy/tree";
treeJSON = d3.json(url, function(error, treeData) {
    ...
    function doubleClick(d) {
        ...
        if (d.name != 'Eukaryota') {
            $.ajax({
                url: 'https://asg-portal-backend-733243988471.europe-west1.run.app/root_organisms/root/filter/results?from=0&size=2000&taxonomyFilter=' + encodedJsonArray,
                type: 'post',
                data: {},
